...
CREATE TABLE `test_processes` (
  ...
  `require_facial_enrollment` tinyint(1) NOT NULL DEFAULT '0',
  `facial_enrollment_policy` enum('inherit','required','disabled') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'inherit',
  `component_validation_policy` enum('inherit','required','disabled') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'inherit',
  `audio_visual_recording_policy` enum('inherit','required','disabled') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'inherit',
  `action_logging_policy` enum('inherit','required','disabled') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'inherit',
...
CREATE TABLE `test_sessions` (
  ...
  `track_activity_enabled` tinyint(1) DEFAULT NULL,
  `user_id` int(10) unsigned NOT NULL,
  `assigned_by` int(10) unsigned DEFAULT NULL,
