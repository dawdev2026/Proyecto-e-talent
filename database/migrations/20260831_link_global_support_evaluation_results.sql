-- Vincula los resultados historicos de la evaluacion de Gestion Global de Soporte
-- con su proceso cuando existe una unica asignacion activa inequívoca.
...
JOIN (
    ...
    FROM (
        ...
        WHERE ea0.process_id IS NULL
          AND p0.code = 'p_a_coordinador_a_de_gesti_n_global_de_soporte'
