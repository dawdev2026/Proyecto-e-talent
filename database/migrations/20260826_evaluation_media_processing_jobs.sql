...
CREATE TABLE IF NOT EXISTS e_talent_evaluaciones_encuestas.evaluation_survey_media_processing_jobs (
    ...
    PRIMARY KEY (id),
    UNIQUE KEY uq_esmpj_evidence (evidence_id),
    KEY idx_esmpj_queue (status, attempts, locked_at, id),
    CONSTRAINT fk_esmpj_evidence FOREIGN KEY (evidence_id) REFERENCES e_talent_evaluaciones_encuestas.evaluation_survey_media_evidence(id) ON DELETE CASCADE
